...
urlpatterns = [path("", views.index, name="index"),
               ...
               path("thread/remove_thread/<int:thread_id>",
                    views.remove_thread, name="remove_thread"),
               path("thread/change_status/<int:thread_id>",
                    views.change_status_thread, name="change_status_thread"),
               ]
